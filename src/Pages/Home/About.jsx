        ...
        <div className="bg-[#f7f7f7] min-h-screen py-10">
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="flex items-center justify-between mb-10">
                    <div
                        className="bg-gradient-to-r from-[#d7e58d] to-[#eef3d2] px-6 py-3 w-[220px]"
                        style={{
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                    ...
                    <div className="lg:w-[75%] w-full text-[15px] leading-8 text-[#2f2f2f]">
                        ...
                        <p className="mb-8">
                            GMPMAX dedicated to pharmaceutical industry, is one of the
                        ...
                        <div className="mb-10">
                            <p>GMPMAX, is a Certified Supplier by China Council for the Promotion of International Trade (CCPIT)</p>
                            <p>GMPMAX, is a Certified Supplier by China Chamber of International Commerce (CCOIC)</p>
                            <p>
                                GMPMAX, is a verified supplier by D&amp;B® Credit Report for
                                GMPMAX is available upon request, please consult to D&amp;B.
                            </p>
                        </div>
                        ...
                        {/* Footer Logo */}
                        <div className="mt-16">
                            <h1 className="text-[70px] font-extrabold text-lime-500 tracking-tight">
                                GMPMAX
                            </h1>

                            <p className="text-lime-700 font-semibold text-lg">
                                GMPMAX, Provides Professional GMP Solutions.
                            </p>

                            <p className="text-lime-700 font-semibold text-lg">
                                GMPMAX, Maximizes Your GMP Compliance.
                            </p>
                        </div>
                    </div>
